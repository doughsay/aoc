defmodule AoC.Day08 do
  ...
  def visible_from_north(_grid, {_x, 0}), do: true
  ...
  def visible_from_south(_grid, {_x, max_y}, max_y), do: true
  ...
  def visible_from_east(_grid, {0, _y}), do: true
  ...
  def visible_from_west(_grid, {max_x, _y}, max_x), do: true
