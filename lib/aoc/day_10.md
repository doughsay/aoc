...
-   `addx V` takes _two cycles_ to complete. _After_ two cycles, the `X`
...
-   During the 20th cycle, register `X` has the value `21`, so the signal
    strength is 20 \* 21 = _420_. (The 20th cycle occurs in the middle of the
